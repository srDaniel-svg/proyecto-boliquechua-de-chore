...
<div id="splash">
    ...
    <div class="splash-content">
        <svg class="splash-llama" viewBox="0 0 120 120" fill="none"><ellipse cx="60" cy="105" rx="28" ry="6" fill="rgba(232,69,10,0.18)"/><path d="M42 90 C42 90 36 72 38 58 C40 46 46 38 46 28 C46 18 52 12 58 14 C63 15.5 65 22 63 30 C68 25 75 23 80 28 C85 33 82 43 77 48 C86 45 93 50 93 60 C93 70 86 77 79 79 L81 90 Z" fill="url(#llamaBody)"/><path d="M58 14 C55 8 60 3 66 5 C72 7 73 14 70 18 C74 16 78 18 78 23 C78 28 73 30 70 28" fill="url(#llamaHead)"/><path d="M60 5 L57 0 L63 2 Z" fill="#FF6B35"/><path d="M66 5 L70 0 L73 4 Z" fill="#FF6B35"/><circle cx="68" cy="14" r="2.5" fill="#FFD166"/><circle cx="68.8" cy="13.5" r="1" fill="#1A0804"/><path d="M50 60 L70 60" stroke="#FFD166" stroke-width="2" stroke-dasharray="3,4" opacity="0.6"/><path d="M48 68 L72 68" stroke="#F5A623" stroke-width="1.5" stroke-dasharray="2,5" opacity="0.5"/><path d="M50 90 L48 105 M56 90 L55 105 M67 90 L68 105 M73 90 L74 105" stroke="#C84008" stroke-width="4" stroke-linecap="round"/><path d="M45 105 L51 105" stroke="#9B2D06" stroke-width="3.5" stroke-linecap="round"/><path d="M52 105 L58 105" stroke="#9B2D06" stroke-width="3.5" stroke-linecap="round"/><path d="M65 105 L71 105" stroke="#9B2D06" stroke-width="3.5" stroke-linecap="round"/><path d="M71 105 L77 105" stroke="#9B2D06" stroke-width="3.5" stroke-linecap="round"/><defs><linearGradient id="llamaBody" x1="38" y1="20" x2="90" y2="95" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FF6B35"/><stop offset="100%" stop-color="#9B2D06"/></linearGradient><linearGradient id="llamaHead" x1="55" y1="0" x2="80" y2="30" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FF8C55"/><stop offset="100%" stop-color="#C84008"/></linearGradient></defs></svg>
...
<!-- ========== GAME LOADER ========== -->
<div id="gameLoader"><div class="gl-rings"><div class="gl-ring"></div><div class="gl-ring"></div><div class="gl-ring"></div><div class="gl-ring"></div></div><div class="gl-content"><svg class="gl-icon" viewBox="0 0 120 120" fill="none"><path d="M42 90 C42 90 36 72 38 58 C40 46 46 38 46 28 C46 18 52 12 58 14 C63 15.5 65 22 63 30 C68 25 75 23 80 28 C85 33 82 43 77 48 C86 45 93 50 93 60 C93 70 86 77 79 79 L81 90 Z" fill="url(#glBody)"/><path d="M58 14 C55 8 60 3 66 5 C72 7 73 14 70 18 C74 16 78 18 78 23 C78 28 73 30 70 28" fill="url(#glHead)"/><path d="M50 90 L48 105 M56 90 L55 105 M67 90 L68 105 M73 90 L74 105" stroke="#C84008" stroke-width="4" stroke-linecap="round"/><defs><linearGradient id="glBody" x1="38" y1="20" x2="90" y2="95" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FF6B35"/><stop offset="100%" stop-color="#9B2D06"/></linearGradient><linearGradient id="glHead" x1="55" y1="0" x2="80" y2="30" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FF8C55"/><stop offset="100%" stop-color="#C84008"/></linearGradient></defs></svg><div class="gl-title" id="glTitle">Cargando...</div><div class="gl-sub">BOLIQUECHUA</div><div class="gl-bar-wrap"><div class="gl-track"><div class="gl-bar" id="glBar"></div></div></div></div></div>
