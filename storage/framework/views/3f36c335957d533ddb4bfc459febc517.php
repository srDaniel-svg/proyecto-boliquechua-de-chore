            ...
            <div class="mountain-node-wrap <?php echo e($isLeft ? 'node-left' : 'node-right'); ?>" id="node-wrap-<?php echo e($nodo->orden); ?>">
                ...
                <?php if($nodo->orden == 20): ?>
                    ...
                    <div style="position: absolute; bottom: 100%; left: 50%; transform: translateX(-50%); margin-bottom: -15px; z-index: 10; pointer-events: none; width: 320px; display: flex; justify-content: center;">
                        <img src="<?php echo e(asset('animaciones condorio en gif/condorio bailando fondo negro_processed.gif')); ?>" alt="Celebracion final" style="width: 100%; max-width: 90vw; transform: scale(0.95);">
                    </div>
                <?php endif; ?>
                ...
                <?php if($nodo->orden == 10): ?>
                    ...
                    <div style="position: absolute; right: 75%; top: calc(50% + 12px); transform: translateY(-50%); z-index: 20; width: clamp(220px, 40vw, 340px);">
                        <div style="position: relative; width: 100%;">
                            ...
                            <img id="llamin-estatico" src="<?php echo e(asset('animaciones condorio en gif/llamin comiendo pasto_processed.gif')); ?>" alt="Llama pastando" style="width: 100%; cursor: pointer; mix-blend-mode: screen;" onclick="playLlaminVideo()">
                            <img id="llamin-hablando" src="<?php echo e(asset('animaciones condorio en gif/llamin hablando_tr.gif')); ?>" style="position: absolute; top: -59px; left: 71px; transform: scale(1.9); width: 100%; height: auto; pointer-events: none; z-index: 30; display: none; mix-blend-mode: screen;">
                            <audio id="llamin-audio" src="<?php echo e(asset('animaciones condorio en gif/llamin hablando.mp4')); ?>" preload="auto"></audio>
                        </div>
                    </div>
                    <script>
