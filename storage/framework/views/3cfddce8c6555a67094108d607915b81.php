...
<div id="app">
    ...
    <main id="main">
        ...
        <div class="cat-grid" id="catGrid">
            ...
            ?>
            <div class="cat-card" onclick="window.location.href='<?php echo e(route('niveles', ['id' => $cat->id])); ?>'">
                <?php if($imgSrc): ?>
                <div style="position: absolute; inset: 0; background-image: url('<?php echo e($imgSrc); ?>'); background-size: cover; background-position: center; z-index: 1;"></div>
                <?php endif; ?>
                <div class="cc-topbar"></div>
                <div class="cc-body" style="height: 100%; justify-content: flex-end; padding-top: 45%;">
                    <div class="cc-name" style="text-shadow: 0 2px 8px rgba(0,0,0,1);"><?php echo e($cat->nombre); ?></div>
...
<div id="cuentos-view">
    ...
    <div style="position: absolute; inset: 0; overflow: hidden; display: flex; align-items: flex-end; justify-content: center; pointer-events: none; z-index: 10;">
        <div class="cuentos-tree-wrapper" style="position: relative; width: 100%; max-width: 1200px; min-width: 800px; aspect-ratio: 1843 / 2261; pointer-events: auto; margin-bottom: -5%;">
            ...
            <div class="nodo-cuento nodo-noche" style="top: 67.4%; left: 24.6%;" onclick="window.location.href='<?php echo e(route('juego', ['id' => 1])); ?>?modo=hablar&es_practica=1'">
                <span class="nodo-icon">🎤</span>
                <div class="nodo-label">Hablar</div>
            </div>
            <div class="nodo-cuento nodo-noche" style="top: 67.7%; left: 67.1%;" onclick="window.location.href='<?php echo e(route('juego', ['id' => 1])); ?>?modo=hablar&es_practica=1'">
            ...
            <div class="nodo-cuento nodo-noche" style="top: 59.8%; left: 68.6%;" onclick="window.location.href='<?php echo e(route('juego', ['id' => 1])); ?>?modo=contrarreloj&es_practica=1'">
                <span class="nodo-icon">⚡</span>
            ...
            <!-- ================= NODOS DÍA (10) ================= -->
            <div class="nodo-cuento nodo-dia nodo-actual" style="top: 65.9%; left: 46.5%;" onclick="window.location.href='<?php echo e(route('juego', ['id' => 1])); ?>?modo=completar&es_practica=1'">
                <img src="<?php echo e(asset('animaciones condorio en gif/condorio esperando_processed.gif')); ?>" class="indicador-pajaro" alt="Indicador">
                <span class="nodo-icon">🧩</span>
    ...
    <div id="proximamente-view">
        <img src="<?php echo e(asset('condorio saludando animado.gif')); ?>" class="proximamente-icon" alt="Correcto">
...
<script>
        ...
        if (cuentosVideo) {
            if (theme === 'dark') {
                if (cuentosVideo.getAttribute('data-current-theme') !== 'dark') {
                    cuentosVideo.src = "<?php echo e(asset('images/fondo de arbol modo oscuro.mp4')); ?>";
                    cuentosVideo.setAttribute('data-current-theme', 'dark');
                }
            } else {
                if (cuentosVideo.getAttribute('data-current-theme') !== 'light') {
                    cuentosVideo.src = "<?php echo e(asset('images/fond de arbol modo claro.mp4')); ?>";
    ...
    <audio id="bg-music-main" src="<?php echo e(asset('canciones de fondo/tema principal.mp3')); ?>" loop preload="auto"></audio>
    <audio id="bg-music-tree" src="<?php echo e(asset('canciones de fondo/tema del arbol.mp3')); ?>" loop preload="auto"></audio>
