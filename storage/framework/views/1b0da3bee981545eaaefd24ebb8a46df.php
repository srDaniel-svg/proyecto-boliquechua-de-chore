...
<head>
    ...
    <style>
        ...
        .btn-imagen-animado:hover {
            transform: scale(1.1) translateY(-2px);
        }
        .btn-imagen-animado:active {
...
<script>
    ...
    let vidas = isPractica ? 3 : <?php echo e($vidas); ?>;
    ...
    function showGameOverPracticaModal() {
        document.getElementById('modalMessage').innerHTML = `
            ...
            <div style="margin-top:20px;">
                <button class="sh-btn" onclick="window.location.href='<?php echo e(route('categorias')); ?>'" style="background:var(--card); color:var(--text); width: 100%;">Volver al Mapa</button>
            </div>
        `;
        document.getElementById('btnRejugar').style.display = 'none';
        document.getElementById('resultModal').style.display = 'flex';
